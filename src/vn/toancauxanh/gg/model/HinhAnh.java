...
@Indexed
@AnalyzerDef(name= "newhinhanh", tokenizer = @TokenizerDef(factory = StandardTokenizerFactory.class), filters = {
		@TokenFilterDef(factory = LowerCaseFilterFactory.class)
		/*@TokenFilterDef(factory = StopFilterFactory.class, params = {
				@Parameter(name = "ignoreCase", value = "false") })*/ })
@Analyzer(definition = "newhinhanh")
public class HinhAnh extends Asset<HinhAnh> {
	public static transient final Logger LOG = LogManager.getLogger(HinhAnh.class.getName());
	...
	@Command
	public void copyArticle(@BindingParam("vm") final HinhAnh vm,

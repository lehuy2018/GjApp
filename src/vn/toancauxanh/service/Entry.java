...
import vn.toancauxanh.cms.service.*;
...
//	public String HINHANH = "";
	...
	@Value("${url.theloai}" + ":" + "${action.xem}")
	public String THELOAIXEM = "";
	@Value("${url.theloai}" + ":" + "${action.them}")
	public String THELOAITHEM = "";
	@Value("${url.theloai}" + ":" + "${action.list}")
	public String THELOAILIST = "";
	@Value("${url.theloai}" + ":" + "${action.xoa}")
	public String THELOAIXOA = "";
	@Value("${url.theloai}" + ":" + "${action.sua}")
	public String THELOAISUA = "";
...
//	@Value("${url.imageH}" + ":" + "${action.xem}")
//	public String HINHANHXEM = "";
//	@Value("${url.imageH}" + ":" + "${action.them}")
//	public String HINHANHTHEM = "";
//	@Value("${url.imageH}" + ":" + "${action.list}")
//	public String HINHANHLIST = "";
//	@Value("${url.imageH}" + ":" + "${action.xoa}")
//	public String HINHANHXOA = "";
//	@Value("${url.imageH}" + ":" + "${action.sua}")
//	public String HINHANHSUA = "";
//	@Value("${url.imageH}" + ":" + "${action.xuatban}")
//	public String HINHANHXUATBAN = "";
	...
	public String[] getRESOURCES() {
		return new String[] { NGUOIDUNG, VAITRO, DONVI,BANNER, CATEGORY, THELOAI, THONGBAO};
	}
...
//	${ctxPath}/cp/baiviet ''
	...
	public final TheloaiService getTheLoais(){
	...
	public final HinhAnhService getHinhAnhs() {
